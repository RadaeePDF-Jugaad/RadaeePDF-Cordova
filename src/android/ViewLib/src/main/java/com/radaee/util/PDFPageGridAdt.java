...
public class PDFPageGridAdt extends BaseAdapter {
    ...
    private int dp2px(float dpValue) {
        return (int) (dpValue * ms_density + 0.5f);
    }
    public PDFPageGridAdt(Context ctx, com.radaee.pdf.Document doc)
    {
        m_ctx = ctx;
        m_doc = doc;
        ms_density = m_ctx.getResources().getDisplayMetrics().density;
        ...
        for(int ip = 0; ip < pages_cnt; ip++)
        {
            ...
            item.m_lay = (RelativeLayout)RelativeLayout.inflate(m_ctx, R.layout.item_page, null);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(dang < 0) dang += 360;
                    fitem.m_img.setPivotX(fitem.m_img.getWidth()/2);
                    fitem.m_img.setPivotY(fitem.m_img.getHeight()/2);//支点在图片中心
